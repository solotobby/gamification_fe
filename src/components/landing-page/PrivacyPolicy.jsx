    ...
    return (
        <div className="container flex gap-10">
            <div className="my-8">
                ...
                <p  className="mb-4">Information we collect</p>
                <p  className="mb-4">How we use your information </p>
                <p  className="mb-4">Log Files</p>
                <p  className="mb-4">Cookies and Web Becons</p>
                <p  className="mb-4">Advertising Partners Privacy Policy</p>
                <p  className="mb-4">Third Party Privacy Policy</p>
                <p  className="mb-4">GDPR Data Protection Rights</p>
                <p  className="mb-4">Children&#39;s Information</p>
            </div>
            <div>
